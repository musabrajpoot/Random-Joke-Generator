 let Jokes = ["What falls, but never needs a bandage? The rain.", 
...
"happy family of three enjoying breakfast at table in domestic kitchenpinterest icon",
"Morsa Images",
...
"high angle view of cheerful grandparents talking with granddaughters while sitting on sofa at homepinterest icon",
"Klaus Vedfelt",
...
"two best friends telling secrets lying in the grasspinterest icon",
"Westend61",
...
"happy multiracial senior women having fun together outdoor   elderly generation people hugging each other at parkpinterest icon",
...
// document.querySelector("div").innerHTML = randomjoke;
...
function handleButtonClick(){
    ...
    const randomElement = getRandomJoke();

    resultElement.textContent=  randomElement;
